...
generate-ssh-keys: ## Generates SSH keys for the JWT library
	...
	U_ID=${UID} docker exec -it --user ${UID} ${DOCKER_BE} openssl genrsa -passout pass:f30777a56cf9fd8d8f1da71399b943bc -out config/jwt/private.pem -aes256 4096
	U_ID=${UID} docker exec -it --user ${UID} ${DOCKER_BE} openssl rsa -pubout -passin pass:f30777a56cf9fd8d8f1da71399b943bc -in config/jwt/private.pem -out config/jwt/public.pem
